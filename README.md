...
Python accounting app with reports, journal, accounts UI & Docker CI
...
Welcome to the **Accounting App** repository. This project is built to deliver a robust and scalable solution tailored to modern development standards.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Shivay00001/accounting_app.git
   ```
